 ...
 * first: the browser ends each save with a contended rich body.
 */
class BrowserRichContendedEditPost extends BrowserRichMergeEditPost
{
    protected static string $resource = BrowserRichContendedPostResource::class;
