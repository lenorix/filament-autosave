...
final class AutosaveSynced
{
     ...
     * @param  array<string, array{theirs: mixed, hash: string}>  $patches  Stale mergeable fields with the other editor's current value (a document for rich content), for the browser to merge locally.
     */
