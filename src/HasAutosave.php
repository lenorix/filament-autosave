...
trait HasAutosave
{
    ...
    protected function usesLegacyTranslatableRelationshipFallback(): bool
    {
        ...
        // Filament 4's translatable hook does not persist relationships during
        // its getState(false) locale pass. Filament 5 does, so only the
        // normalized Filament 4 version needs the fallback.
